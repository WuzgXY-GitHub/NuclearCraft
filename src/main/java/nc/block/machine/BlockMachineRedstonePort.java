...
public class BlockMachineRedstonePort extends BlockMachinePart implements IActivatable {
	
	public BlockMachineRedstonePort() {
		super();
	...
	public TileEntity createNewTileEntity(World world, int metadata) {
		return new TileMachineRedstonePort();
	}
