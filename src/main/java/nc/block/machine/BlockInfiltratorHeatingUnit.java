...
public class BlockInfiltratorHeatingUnit extends BlockMachinePart implements IActivatable {
	
	public BlockInfiltratorHeatingUnit() {
		super();
	...
	public TileEntity createNewTileEntity(World world, int metadata) {
		return new TileInfiltratorHeatingUnit();
	}
