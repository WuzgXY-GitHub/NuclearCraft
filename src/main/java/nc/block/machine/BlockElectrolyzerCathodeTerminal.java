...
public class BlockElectrolyzerCathodeTerminal extends BlockMachinePart implements IDynamicState {
	
	public BlockElectrolyzerCathodeTerminal() {
		super();
	...
	public TileEntity createNewTileEntity(World world, int metadata) {
		return new TileElectrolyzerCathodeTerminal();
	}
