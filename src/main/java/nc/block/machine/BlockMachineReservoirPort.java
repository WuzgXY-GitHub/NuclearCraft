...
public class BlockMachineReservoirPort extends BlockMachinePart implements IActivatable {
	
	public BlockMachineReservoirPort() {
		super();
	...
	public TileEntity createNewTileEntity(World world, int metadata) {
		return new TileMachineReservoirPort();
	}
