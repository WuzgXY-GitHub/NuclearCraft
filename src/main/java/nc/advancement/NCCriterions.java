...
public class NCCriterions {
	...
	public static final List<NCCriterionTrigger> CRITERION_TRIGGERS = Arrays.asList(ELECTROLYZER_ASSEMBLED, DISTILLER_ASSEMBLED, SOLID_FISSION_ASSEMBLED, SALT_FISSION_ASSEMBLED, HEAT_EXCHANGER_ASSEMBLED, TURBINE_ASSEMBLED, CONDENSER_ASSEMBLED);
}
