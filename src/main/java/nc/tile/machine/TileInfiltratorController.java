...
public class TileInfiltratorController extends TileMachinePart implements IMachineController<TileInfiltratorController> {
	
	protected final TileContainerInfo<TileInfiltratorController> info = TileInfoHandler.getTileContainerInfo("infiltrator_controller");
	
	protected boolean isRenderer = false;
	
	public TileInfiltratorController() {
	...
	@Override
	public TileContainerInfo<TileInfiltratorController> getContainerInfo() {
		return info;
	}
